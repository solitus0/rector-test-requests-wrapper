...
class PostAuthorizedRequestWithContentRector extends AbstractRector
{
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        return new MethodCall(
            new Variable('this'),
            'postAuthorizedRequestWithContent',
            $newArgs
        );
    }
    ...
    private function shouldSkip(MethodCall $node): bool
    {
        ...
        if (!$this->isStringArgument($node->args[0], 'POST')) {
            return true;
        }
        ...
        if (!$node->args[5]->value instanceof String_) {
            return true;
        }
    ...
    {
        return $arg->value instanceof String_ && $arg->value->value === $value;
    }
